...
const GetListingFromId = () => {
  ...
  return (
    <div className="my-10">
      <BackButton />
      <div className="w-[100%] md:min-h-[60dvh]  flex justify-center items-center ">
        <Card className="w-[90%] md:w-[80%] py-3 flex flex-col-reverse md:flex-row md:justify-around justify-between items-center my-5">
